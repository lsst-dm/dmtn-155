...
For example, by maintaining resources that enable crowd-sourced problem solving, curating documentation and tutorials, serving as an interface between project and community, and coordinating expertise to respond to issues that may arise.
Now, during construction, the CET is making plans for a full community support model and beginning to take on some initial responsibilities.
