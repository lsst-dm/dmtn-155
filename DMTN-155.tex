...
\setDocAbstract{%
This document describes the interim (construction-era) model for online interactions between the Rubin Data Management (\gls{DM}) construction staff (including the DM System Science Team; \gls{DM-SST}) and members of the global science community (including the Science Collaborations).
}
...
Now, during construction, the CET is making plans for a full community support model and beginning to take on some initial responsibilities, and will focus on providing support for community participation in Data Preview 0 (DP0; \citeds{RTN-001}).
