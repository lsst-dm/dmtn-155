...
The full model for community support during operations will be described in `RTN-006`_, and will include motivations for the choice of Discourse for the Community Forum (see also `SQR-011`_).
